...
class Days2MembershipContainer extends StatefulWidget {
  const Days2MembershipContainer({super.key});

  @override
  State<Days2MembershipContainer> createState() =>
      _Days2MembershipContainerState();
}

class _Days2MembershipContainerState extends State<Days2MembershipContainer> {
  @override
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Padding(
            ...
            child: InkWell(
              onTap: () => Get.toNamed(RouteName.renew2DaysMembership),
              child: Container(
